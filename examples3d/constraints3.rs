...
use nphysics3d::joint::{FreeJoint, FixedJoint, Joint, RevoluteJoint, FixedConstraint, RevoluteConstraint};
...
fn main() {
    ...
    for j in 0usize .. num {
        ...
        let revolute_constraint = RevoluteConstraint::new(
            ...
            na::origin(), Vector3::x_axis(), Point3::new(0.0, 0.0, rad * 3.0), Vector3::x_axis());
         ...
         * Create the collider.
         */
        world.add_collider(COLLIDER_MARGIN, geom.clone(), rb, Isometry3::identity(), true);
