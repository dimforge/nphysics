...
pub trait Joint<N: RealField, Handle: BodyHandle>: Downcast + Send + Sync {
    ...
    fn velocity_constraints(
        ...
        _jacobians: &mut [N],
        _velocity_constraints: &mut ConstraintSet<N, Handle, usize>,
    ) {}
...
impl_downcast!(Joint<N, Handle> where N: RealField, Handle: BodyHandle);
