...
impl<N: RealField, Bodies: BodySet<N>> JointConstraint<N, Bodies> for MouseConstraint<N> {
...
impl<N: RealField, Bodies: BodySet<N>> NonlinearConstraintGenerator<N, Bodies> for MouseConstraint<N> {
