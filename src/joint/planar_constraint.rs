...
impl<N: RealField, Bodies: BodySet<N>> JointConstraint<N, Bodies> for PlanarConstraint<N> {
...
impl<N: RealField, Bodies: BodySet<N>> NonlinearConstraintGenerator<N, Bodies> for PlanarConstraint<N> {
