...
use na::{self, Isometry3, Real, U6, Vector, Vector3, Vector6};
...
impl<N: Real> Force3<N> {
    ...
    #[inline]
    pub fn shifted_linear_force(linear: Vector3<N>, shift: Vector3<N>) -> Self {
        Self::new(linear, shift.cross(&linear))
    }
