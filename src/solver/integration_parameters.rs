...
pub struct IntegrationParameters<N: RealField> {
    ...
    ///
    /// Default: `false`.
    pub return_between_substeps: bool,
    ...
    /// Maximum number of substeps performed by the  solver (default: 3).
    pub max_ccd_substeps: usize,
    /// Controls the number of Porximity::Intersecting events generated by a trigger during CCD resolution (default: false).
    ///
